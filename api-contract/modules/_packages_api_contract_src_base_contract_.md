...
*Defined in [packages/api-contract/src/base/Contract.ts:28](https://github.com/polkadot-js/api/blob/73eaa9fe1/packages/api-contract/src/base/Contract.ts#L28)*
