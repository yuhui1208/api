...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/5e8ae793c3/packages/api-contract/src/base/Contract.ts#L25)*
