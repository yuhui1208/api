...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/3d67b75059/packages/api-contract/src/base/Contract.ts#L25)*
