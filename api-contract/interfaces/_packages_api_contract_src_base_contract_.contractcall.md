...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/f748fcd46d/packages/api-contract/src/base/Contract.ts#L25)*
