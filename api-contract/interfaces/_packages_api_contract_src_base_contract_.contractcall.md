...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/e1cb62d2d/packages/api-contract/src/base/Contract.ts#L25)*
