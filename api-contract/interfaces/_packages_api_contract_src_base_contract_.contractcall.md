...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/94e9fd2b17/packages/api-contract/src/base/Contract.ts#L25)*
