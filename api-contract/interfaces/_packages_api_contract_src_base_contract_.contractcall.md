...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/80c578fe7/packages/api-contract/src/base/Contract.ts#L25)*
