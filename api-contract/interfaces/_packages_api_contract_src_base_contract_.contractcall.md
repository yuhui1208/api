...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/065f39ba6d/packages/api-contract/src/base/Contract.ts#L27)*
