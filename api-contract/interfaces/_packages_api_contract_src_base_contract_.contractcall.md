...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/918bb73547/packages/api-contract/src/base/Contract.ts#L27)*
