...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/0a8d2e5ac1/packages/api-contract/src/base/Contract.ts#L27)*
