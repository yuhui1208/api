...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/b59b60ae1f/packages/api-contract/src/base/Contract.ts#L27)*
