...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/eb6b3c5bd4/packages/api-contract/src/base/Contract.ts#L25)*
