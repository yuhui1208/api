...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/467ccc5681/packages/api-contract/src/base/Contract.ts#L27)*
