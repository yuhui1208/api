...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/b579b18fad/packages/api-contract/src/base/Contract.ts#L27)*
