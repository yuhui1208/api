...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/00bc441f0e/packages/api-contract/src/base/Contract.ts#L27)*
