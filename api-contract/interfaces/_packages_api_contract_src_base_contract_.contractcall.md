...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/70e0f19ad/packages/api-contract/src/base/Contract.ts#L25)*
