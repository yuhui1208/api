...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/53655019b/packages/api-contract/src/base/Contract.ts#L25)*
