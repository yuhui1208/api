...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/637069d723/packages/api-contract/src/base/Contract.ts#L25)*
