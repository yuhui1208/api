...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/82e71fd51/packages/api-contract/src/base/Contract.ts#L25)*
