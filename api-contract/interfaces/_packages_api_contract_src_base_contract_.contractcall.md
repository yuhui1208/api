...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/6ae75ba92e/packages/api-contract/src/base/Contract.ts#L27)*
