...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/eee36537d/packages/api-contract/src/base/Contract.ts#L25)*
