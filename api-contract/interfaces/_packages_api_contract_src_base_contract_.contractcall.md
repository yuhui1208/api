...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/5af98cc89e/packages/api-contract/src/base/Contract.ts#L27)*
