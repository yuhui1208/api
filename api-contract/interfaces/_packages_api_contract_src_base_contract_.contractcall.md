...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/d099cceda/packages/api-contract/src/base/Contract.ts#L25)*
