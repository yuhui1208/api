...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/45c2c40a3e/packages/api-contract/src/base/Contract.ts#L27)*
