...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/2f78329738/packages/api-contract/src/base/Contract.ts#L25)*
