...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/e88ebf7b2e/packages/api-contract/src/base/Contract.ts#L25)*
