...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/c4323d5e94/packages/api-contract/src/base/Contract.ts#L25)*
