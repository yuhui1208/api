...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/5a90da5df8/packages/api-contract/src/base/Contract.ts#L25)*
