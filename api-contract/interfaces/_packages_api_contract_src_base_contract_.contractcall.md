...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/4b3b853c27/packages/api-contract/src/base/Contract.ts#L27)*
