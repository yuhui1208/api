...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/533abb76f/packages/api-contract/src/base/Contract.ts#L25)*
