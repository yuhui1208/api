...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/ad8ad42344/packages/api-contract/src/base/Contract.ts#L27)*
