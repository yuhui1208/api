...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/e6806ed7f/packages/api-contract/src/base/Contract.ts#L25)*
