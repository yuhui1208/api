...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/35c37aa66/packages/api-contract/src/base/Contract.ts#L25)*
