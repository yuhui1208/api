...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/3989ae67b2/packages/api-contract/src/base/Contract.ts#L25)*
