...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/e7be062522/packages/api-contract/src/base/Contract.ts#L27)*
