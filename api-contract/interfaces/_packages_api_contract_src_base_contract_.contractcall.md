...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/fe951c264/packages/api-contract/src/base/Contract.ts#L25)*
