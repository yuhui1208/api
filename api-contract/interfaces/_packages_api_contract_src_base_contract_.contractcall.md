...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/fa935156e/packages/api-contract/src/base/Contract.ts#L25)*
