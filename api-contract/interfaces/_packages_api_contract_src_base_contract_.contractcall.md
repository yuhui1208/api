...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/c2705bdfda/packages/api-contract/src/base/Contract.ts#L27)*
