...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/7876bb9ced/packages/api-contract/src/base/Contract.ts#L25)*
