...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/8f675053a4/packages/api-contract/src/base/Contract.ts#L25)*
