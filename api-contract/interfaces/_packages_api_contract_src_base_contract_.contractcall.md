...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/e425a38a7c/packages/api-contract/src/base/Contract.ts#L27)*
