...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/3151c08aca/packages/api-contract/src/base/Contract.ts#L27)*
