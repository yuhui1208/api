...
*Defined in [packages/api-contract/src/base/Contract.ts:27](https://github.com/polkadot-js/api/blob/dac3261a16/packages/api-contract/src/base/Contract.ts#L27)*
