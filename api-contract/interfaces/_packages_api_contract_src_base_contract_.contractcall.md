...
*Defined in [packages/api-contract/src/base/Contract.ts:25](https://github.com/polkadot-js/api/blob/cab338e26d/packages/api-contract/src/base/Contract.ts#L25)*
