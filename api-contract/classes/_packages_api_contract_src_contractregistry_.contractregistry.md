...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/df229ffb8a/packages/api-contract/src/MetaRegistry.ts#L107)*
