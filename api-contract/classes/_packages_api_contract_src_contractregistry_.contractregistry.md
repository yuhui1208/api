...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/01a36a994/packages/api-contract/src/MetaRegistry.ts#L107)*
