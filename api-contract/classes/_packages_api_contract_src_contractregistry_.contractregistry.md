...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/c4323d5e94/packages/api-contract/src/MetaRegistry.ts#L107)*
