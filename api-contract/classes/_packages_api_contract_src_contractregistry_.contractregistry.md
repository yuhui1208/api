...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/277ea92fd/packages/api-contract/src/MetaRegistry.ts#L107)*
