...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/8f675053a4/packages/api-contract/src/MetaRegistry.ts#L107)*
