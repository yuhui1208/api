...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/bcdfcce89/packages/api-contract/src/MetaRegistry.ts#L107)*
