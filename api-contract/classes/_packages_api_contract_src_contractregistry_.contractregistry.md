...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/c7e6e4003/packages/api-contract/src/MetaRegistry.ts#L107)*
