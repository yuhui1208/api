...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/82e71fd51/packages/api-contract/src/MetaRegistry.ts#L107)*
