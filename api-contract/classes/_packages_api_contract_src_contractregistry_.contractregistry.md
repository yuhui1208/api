...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/45fb6d44ad/packages/api-contract/src/MetaRegistry.ts#L107)*
