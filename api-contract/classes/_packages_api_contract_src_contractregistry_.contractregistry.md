...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/fcfcbb2d9/packages/api-contract/src/MetaRegistry.ts#L107)*
