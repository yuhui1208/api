...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/b579b18fad/packages/api-contract/src/MetaRegistry.ts#L107)*
