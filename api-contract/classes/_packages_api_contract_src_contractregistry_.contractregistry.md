...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/cab338e26d/packages/api-contract/src/MetaRegistry.ts#L107)*
