...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/658dda66a/packages/api-contract/src/MetaRegistry.ts#L107)*
