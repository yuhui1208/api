...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/6ae75ba92e/packages/api-contract/src/MetaRegistry.ts#L107)*
