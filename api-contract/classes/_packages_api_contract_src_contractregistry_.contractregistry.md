...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/45c2c40a3e/packages/api-contract/src/MetaRegistry.ts#L107)*
