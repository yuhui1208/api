...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/eb6b3c5bd4/packages/api-contract/src/MetaRegistry.ts#L107)*
