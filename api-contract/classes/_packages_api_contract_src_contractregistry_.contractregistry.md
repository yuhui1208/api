...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/e6806ed7f/packages/api-contract/src/MetaRegistry.ts#L107)*
