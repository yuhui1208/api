...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/00d3a1174/packages/api-contract/src/MetaRegistry.ts#L107)*
