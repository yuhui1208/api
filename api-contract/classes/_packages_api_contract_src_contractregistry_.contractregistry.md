...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/a8d1dd063/packages/api-contract/src/MetaRegistry.ts#L107)*
