...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/e7be062522/packages/api-contract/src/MetaRegistry.ts#L107)*
