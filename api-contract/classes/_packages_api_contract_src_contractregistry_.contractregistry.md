...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/430beb9f25/packages/api-contract/src/MetaRegistry.ts#L107)*
