...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/5a90da5df8/packages/api-contract/src/MetaRegistry.ts#L107)*
