...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/6e6fa4a97c/packages/api-contract/src/MetaRegistry.ts#L107)*
