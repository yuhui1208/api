...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/d099cceda/packages/api-contract/src/MetaRegistry.ts#L107)*
