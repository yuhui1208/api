...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/97b5c699b/packages/api-contract/src/MetaRegistry.ts#L107)*
