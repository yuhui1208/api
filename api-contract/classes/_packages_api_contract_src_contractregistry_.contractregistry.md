...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/54b4c2620/packages/api-contract/src/MetaRegistry.ts#L107)*
