...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/e1cb62d2d/packages/api-contract/src/MetaRegistry.ts#L107)*
