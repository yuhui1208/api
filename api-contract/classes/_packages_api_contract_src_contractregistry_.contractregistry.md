...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/391c98c845/packages/api-contract/src/MetaRegistry.ts#L107)*
