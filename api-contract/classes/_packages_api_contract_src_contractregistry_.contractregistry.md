...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/a1df86468/packages/api-contract/src/MetaRegistry.ts#L107)*
