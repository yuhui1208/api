...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/73eaa9fe1/packages/api-contract/src/MetaRegistry.ts#L107)*
