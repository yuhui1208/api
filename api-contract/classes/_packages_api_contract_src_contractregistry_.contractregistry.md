...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/94e9fd2b17/packages/api-contract/src/MetaRegistry.ts#L107)*
