...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/9d1af1eae/packages/api-contract/src/MetaRegistry.ts#L107)*
