...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/f748fcd46d/packages/api-contract/src/MetaRegistry.ts#L107)*
