...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/5e8ae793c3/packages/api-contract/src/MetaRegistry.ts#L107)*
