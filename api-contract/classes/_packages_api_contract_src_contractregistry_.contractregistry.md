...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/b6d1be6ee5/packages/api-contract/src/MetaRegistry.ts#L107)*
