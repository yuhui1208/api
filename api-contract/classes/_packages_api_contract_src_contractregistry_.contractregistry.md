...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/56e4cbdb2/packages/api-contract/src/MetaRegistry.ts#L107)*
