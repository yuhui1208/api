...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/4b3b853c27/packages/api-contract/src/MetaRegistry.ts#L107)*
