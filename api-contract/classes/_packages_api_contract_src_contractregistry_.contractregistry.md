...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/3cf67c975/packages/api-contract/src/MetaRegistry.ts#L107)*
