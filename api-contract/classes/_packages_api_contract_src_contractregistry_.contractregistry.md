...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/5af98cc89e/packages/api-contract/src/MetaRegistry.ts#L107)*
