...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/6bd10daf43/packages/api-contract/src/MetaRegistry.ts#L107)*
