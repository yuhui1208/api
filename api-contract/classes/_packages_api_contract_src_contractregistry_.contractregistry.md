...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/519d9c8fa/packages/api-contract/src/MetaRegistry.ts#L107)*
