...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/5adc846e4/packages/api-contract/src/MetaRegistry.ts#L107)*
