...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/7a1089df79/packages/api-contract/src/MetaRegistry.ts#L107)*
