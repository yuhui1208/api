...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/eee36537d/packages/api-contract/src/MetaRegistry.ts#L107)*
