...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/c2ff1b32a/packages/api-contract/src/MetaRegistry.ts#L107)*
