...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/5eb491dc6/packages/api-contract/src/MetaRegistry.ts#L107)*
