...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/1cf4d6b9b/packages/api-contract/src/MetaRegistry.ts#L107)*
