...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/e88ebf7b2e/packages/api-contract/src/MetaRegistry.ts#L107)*
