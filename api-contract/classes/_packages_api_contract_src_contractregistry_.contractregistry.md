...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/6df466d9e/packages/api-contract/src/MetaRegistry.ts#L107)*
