...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/0a0aa742b/packages/api-contract/src/MetaRegistry.ts#L107)*
