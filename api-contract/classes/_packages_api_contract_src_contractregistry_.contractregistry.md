...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/3c8cd499c/packages/api-contract/src/MetaRegistry.ts#L107)*
