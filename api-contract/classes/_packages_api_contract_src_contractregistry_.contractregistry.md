...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/533abb76f/packages/api-contract/src/MetaRegistry.ts#L107)*
