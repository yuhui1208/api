...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/77c3a701d/packages/api-contract/src/MetaRegistry.ts#L107)*
