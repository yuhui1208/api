...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/28ef291c40/packages/api-contract/src/MetaRegistry.ts#L107)*
