...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/dac3261a16/packages/api-contract/src/MetaRegistry.ts#L107)*
