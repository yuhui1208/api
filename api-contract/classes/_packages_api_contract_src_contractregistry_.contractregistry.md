...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/ce0523eb1/packages/api-contract/src/MetaRegistry.ts#L107)*
