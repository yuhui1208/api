...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/b59b60ae1f/packages/api-contract/src/MetaRegistry.ts#L107)*
