...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/395dc79ef7/packages/api-contract/src/MetaRegistry.ts#L107)*
