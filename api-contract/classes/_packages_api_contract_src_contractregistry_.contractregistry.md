...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/fe951c264/packages/api-contract/src/MetaRegistry.ts#L107)*
