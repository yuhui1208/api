...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/c2705bdfda/packages/api-contract/src/MetaRegistry.ts#L107)*
