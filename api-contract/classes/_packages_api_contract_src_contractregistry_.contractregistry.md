...
*Defined in [packages/api-contract/src/MetaRegistry.ts:107](https://github.com/polkadot-js/api/blob/1beaf9f20/packages/api-contract/src/MetaRegistry.ts#L107)*
