...
*Defined in [packages/api-contract/src/promise/PromiseContract.ts:14](https://github.com/polkadot-js/api/blob/24d8915005/packages/api-contract/src/promise/PromiseContract.ts#L14)*
...
*Defined in [packages/api-contract/src/base/Contract.ts:35](https://github.com/polkadot-js/api/blob/24d8915005/packages/api-contract/src/base/Contract.ts#L35)*
...
*Defined in [packages/api-contract/src/base/util.ts:70](https://github.com/polkadot-js/api/blob/24d8915005/packages/api-contract/src/base/util.ts#L70)*
...
*Defined in [packages/api-contract/src/base/Contract.ts:43](https://github.com/polkadot-js/api/blob/24d8915005/packages/api-contract/src/base/Contract.ts#L43)*
...
*Defined in [packages/api-contract/src/base/Contract.ts:44](https://github.com/polkadot-js/api/blob/24d8915005/packages/api-contract/src/base/Contract.ts#L44)*
