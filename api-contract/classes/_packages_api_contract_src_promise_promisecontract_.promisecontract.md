...
*Defined in [packages/api-contract/src/promise/PromiseContract.ts:14](https://github.com/polkadot-js/api/blob/1cf4d6b9b/packages/api-contract/src/promise/PromiseContract.ts#L14)*
...
*Defined in [packages/api-contract/src/base/Contract.ts:33](https://github.com/polkadot-js/api/blob/1cf4d6b9b/packages/api-contract/src/base/Contract.ts#L33)*
...
*Defined in [packages/api-contract/src/base/util.ts:70](https://github.com/polkadot-js/api/blob/1cf4d6b9b/packages/api-contract/src/base/util.ts#L70)*
...
*Defined in [packages/api-contract/src/base/Contract.ts:41](https://github.com/polkadot-js/api/blob/1cf4d6b9b/packages/api-contract/src/base/Contract.ts#L41)*
...
*Defined in [packages/api-contract/src/base/Contract.ts:42](https://github.com/polkadot-js/api/blob/1cf4d6b9b/packages/api-contract/src/base/Contract.ts#L42)*
