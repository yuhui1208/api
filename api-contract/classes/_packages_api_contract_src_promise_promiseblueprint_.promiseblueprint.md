...
*Defined in [packages/api-contract/src/promise/PromiseBlueprint.ts:14](https://github.com/polkadot-js/api/blob/e425a38a7c/packages/api-contract/src/promise/PromiseBlueprint.ts#L14)*
