...
*Defined in [packages/api-contract/src/promise/PromiseBlueprint.ts:14](https://github.com/polkadot-js/api/blob/45fb6d44ad/packages/api-contract/src/promise/PromiseBlueprint.ts#L14)*
...
*Defined in [packages/api-contract/src/base/Blueprint.ts:38](https://github.com/polkadot-js/api/blob/45fb6d44ad/packages/api-contract/src/base/Blueprint.ts#L38)*
...
*Defined in [packages/api-contract/src/base/Blueprint.ts:46](https://github.com/polkadot-js/api/blob/45fb6d44ad/packages/api-contract/src/base/Blueprint.ts#L46)*
