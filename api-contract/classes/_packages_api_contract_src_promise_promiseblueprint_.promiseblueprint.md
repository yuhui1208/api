...
*Defined in [packages/api-contract/src/promise/PromiseBlueprint.ts:14](https://github.com/polkadot-js/api/blob/fe951c264/packages/api-contract/src/promise/PromiseBlueprint.ts#L14)*
...
*Defined in [packages/api-contract/src/base/Blueprint.ts:38](https://github.com/polkadot-js/api/blob/fe951c264/packages/api-contract/src/base/Blueprint.ts#L38)*
...
*Defined in [packages/api-contract/src/base/Blueprint.ts:46](https://github.com/polkadot-js/api/blob/fe951c264/packages/api-contract/src/base/Blueprint.ts#L46)*
