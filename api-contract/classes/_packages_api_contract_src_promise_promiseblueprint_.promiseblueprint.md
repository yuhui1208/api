...
*Defined in [packages/api-contract/src/promise/PromiseBlueprint.ts:14](https://github.com/polkadot-js/api/blob/b59b60ae1f/packages/api-contract/src/promise/PromiseBlueprint.ts#L14)*
...
*Defined in [packages/api-contract/src/base/Blueprint.ts:39](https://github.com/polkadot-js/api/blob/b59b60ae1f/packages/api-contract/src/base/Blueprint.ts#L39)*
...
*Defined in [packages/api-contract/src/base/Blueprint.ts:47](https://github.com/polkadot-js/api/blob/b59b60ae1f/packages/api-contract/src/base/Blueprint.ts#L47)*
