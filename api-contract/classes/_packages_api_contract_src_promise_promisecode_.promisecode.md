...
*Defined in [packages/api-contract/src/promise/PromiseCode.ts:13](https://github.com/polkadot-js/api/blob/0a8d2e5ac1/packages/api-contract/src/promise/PromiseCode.ts#L13)*
...
*Defined in [packages/api-contract/src/base/Code.ts:39](https://github.com/polkadot-js/api/blob/0a8d2e5ac1/packages/api-contract/src/base/Code.ts#L39)*
...
*Defined in [packages/api-contract/src/base/Code.ts:47](https://github.com/polkadot-js/api/blob/0a8d2e5ac1/packages/api-contract/src/base/Code.ts#L47)*
