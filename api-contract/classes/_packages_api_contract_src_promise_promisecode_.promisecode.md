...
*Defined in [packages/api-contract/src/promise/PromiseCode.ts:13](https://github.com/polkadot-js/api/blob/6df466d9e/packages/api-contract/src/promise/PromiseCode.ts#L13)*
...
*Defined in [packages/api-contract/src/base/Code.ts:38](https://github.com/polkadot-js/api/blob/6df466d9e/packages/api-contract/src/base/Code.ts#L38)*
...
*Defined in [packages/api-contract/src/base/Code.ts:46](https://github.com/polkadot-js/api/blob/6df466d9e/packages/api-contract/src/base/Code.ts#L46)*
