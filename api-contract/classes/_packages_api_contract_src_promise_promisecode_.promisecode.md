...
*Defined in [packages/api-contract/src/promise/PromiseCode.ts:13](https://github.com/polkadot-js/api/blob/e6806ed7f/packages/api-contract/src/promise/PromiseCode.ts#L13)*
