...
*Defined in [packages/api-contract/src/promise/PromiseCode.ts:13](https://github.com/polkadot-js/api/blob/ebe6d03762/packages/api-contract/src/promise/PromiseCode.ts#L13)*
...
*Defined in [packages/api-contract/src/base/Code.ts:38](https://github.com/polkadot-js/api/blob/ebe6d03762/packages/api-contract/src/base/Code.ts#L38)*
...
*Defined in [packages/api-contract/src/base/Code.ts:46](https://github.com/polkadot-js/api/blob/ebe6d03762/packages/api-contract/src/base/Code.ts#L46)*
