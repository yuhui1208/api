...
*Defined in [packages/api-contract/src/promise/PromiseCode.ts:13](https://github.com/polkadot-js/api/blob/45fb6d44ad/packages/api-contract/src/promise/PromiseCode.ts#L13)*
