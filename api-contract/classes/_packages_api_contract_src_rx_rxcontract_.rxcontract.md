...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/5af98cc89e/packages/api-contract/src/rx/RxContract.ts#L14)*
