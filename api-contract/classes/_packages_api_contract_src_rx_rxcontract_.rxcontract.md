...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/80c578fe7/packages/api-contract/src/rx/RxContract.ts#L14)*
