...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/3989ae67b2/packages/api-contract/src/rx/RxContract.ts#L14)*
