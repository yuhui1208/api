...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/9188e29dcc/packages/api-contract/src/rx/RxContract.ts#L14)*
