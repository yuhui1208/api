...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/0a0aa742b/packages/api-contract/src/rx/RxContract.ts#L14)*
