...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/e425a38a7c/packages/api-contract/src/rx/RxContract.ts#L14)*
