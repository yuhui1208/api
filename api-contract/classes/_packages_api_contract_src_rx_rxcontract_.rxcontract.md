...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/eb6b3c5bd4/packages/api-contract/src/rx/RxContract.ts#L14)*
