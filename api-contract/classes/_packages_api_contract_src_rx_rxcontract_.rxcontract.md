...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/70e0f19ad/packages/api-contract/src/rx/RxContract.ts#L14)*
