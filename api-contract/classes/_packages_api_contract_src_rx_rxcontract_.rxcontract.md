...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/fe951c264/packages/api-contract/src/rx/RxContract.ts#L14)*
