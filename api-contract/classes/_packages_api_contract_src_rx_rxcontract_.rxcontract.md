...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/8f675053a4/packages/api-contract/src/rx/RxContract.ts#L14)*
