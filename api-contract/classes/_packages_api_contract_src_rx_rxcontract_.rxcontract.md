...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/f748fcd46d/packages/api-contract/src/rx/RxContract.ts#L14)*
