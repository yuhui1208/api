...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/fcfcbb2d9/packages/api-contract/src/rx/RxContract.ts#L14)*
