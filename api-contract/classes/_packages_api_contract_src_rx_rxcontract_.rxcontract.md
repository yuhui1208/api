...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/35c37aa66/packages/api-contract/src/rx/RxContract.ts#L14)*
