...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/533abb76f/packages/api-contract/src/rx/RxContract.ts#L14)*
