...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/eee36537d/packages/api-contract/src/rx/RxContract.ts#L14)*
