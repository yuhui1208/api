...
*Defined in [packages/api-contract/src/rx/RxContract.ts:14](https://github.com/polkadot-js/api/blob/b59b60ae1f/packages/api-contract/src/rx/RxContract.ts#L14)*
