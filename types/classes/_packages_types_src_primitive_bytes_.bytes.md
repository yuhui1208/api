...
*Defined in [packages/types/src/primitive/Bytes.ts:47](https://github.com/polkadot-js/api/blob/77c3a701d/packages/types/src/primitive/Bytes.ts#L47)*
...
*Defined in [packages/types/src/primitive/Bytes.ts:62](https://github.com/polkadot-js/api/blob/77c3a701d/packages/types/src/primitive/Bytes.ts#L62)*
