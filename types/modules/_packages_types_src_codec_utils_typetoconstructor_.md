...
*Defined in [packages/types/src/codec/utils/typeToConstructor.ts:9](https://github.com/polkadot-js/api/blob/1beaf9f20/packages/types/src/codec/utils/typeToConstructor.ts#L9)*
