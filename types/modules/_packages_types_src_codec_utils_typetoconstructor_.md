...
*Defined in [packages/types/src/codec/utils/typeToConstructor.ts:9](https://github.com/polkadot-js/api/blob/e1cb62d2d/packages/types/src/codec/utils/typeToConstructor.ts#L9)*
