...
*Defined in [packages/types/src/codec/utils/typeToConstructor.ts:9](https://github.com/polkadot-js/api/blob/eb6b3c5bd4/packages/types/src/codec/utils/typeToConstructor.ts#L9)*
