...
*Defined in [packages/types/src/create/createClass.ts:43](https://github.com/polkadot-js/api/blob/00d3a1174/packages/types/src/create/createClass.ts#L43)*
...
*Defined in [packages/types/src/create/createClass.ts:38](https://github.com/polkadot-js/api/blob/00d3a1174/packages/types/src/create/createClass.ts#L38)*
...
*Defined in [packages/types/src/create/createClass.ts:30](https://github.com/polkadot-js/api/blob/00d3a1174/packages/types/src/create/createClass.ts#L30)*
...
*Defined in [packages/types/src/create/createClass.ts:182](https://github.com/polkadot-js/api/blob/00d3a1174/packages/types/src/create/createClass.ts#L182)*
