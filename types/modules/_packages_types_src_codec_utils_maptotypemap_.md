...
*Defined in [packages/types/src/codec/utils/mapToTypeMap.ts:12](https://github.com/polkadot-js/api/blob/e1cb62d2d/packages/types/src/codec/utils/mapToTypeMap.ts#L12)*
