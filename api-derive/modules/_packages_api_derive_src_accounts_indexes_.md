...
*Defined in [packages/api-derive/src/accounts/indexes.ts:75](https://github.com/polkadot-js/api/blob/00bc441f0e/packages/api-derive/src/accounts/indexes.ts#L75)*
