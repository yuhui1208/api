...
*Defined in [packages/api-derive/src/accounts/indexes.ts:75](https://github.com/polkadot-js/api/blob/8f675053a4/packages/api-derive/src/accounts/indexes.ts#L75)*
