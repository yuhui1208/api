...
*Defined in [packages/api-derive/src/accounts/indexes.ts:75](https://github.com/polkadot-js/api/blob/6239818c2/packages/api-derive/src/accounts/indexes.ts#L75)*
