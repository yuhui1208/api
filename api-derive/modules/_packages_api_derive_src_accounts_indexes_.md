...
*Defined in [packages/api-derive/src/accounts/indexes.ts:75](https://github.com/polkadot-js/api/blob/77c3a701d/packages/api-derive/src/accounts/indexes.ts#L75)*
