...
*Defined in [packages/api-derive/src/accounts/indexes.ts:75](https://github.com/polkadot-js/api/blob/00d3a1174/packages/api-derive/src/accounts/indexes.ts#L75)*
