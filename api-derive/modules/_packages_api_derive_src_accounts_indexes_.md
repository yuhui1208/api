...
*Defined in [packages/api-derive/src/accounts/indexes.ts:75](https://github.com/polkadot-js/api/blob/97b5c699b/packages/api-derive/src/accounts/indexes.ts#L75)*
