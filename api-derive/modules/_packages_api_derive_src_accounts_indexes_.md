...
*Defined in [packages/api-derive/src/accounts/indexes.ts:75](https://github.com/polkadot-js/api/blob/eb6b3c5bd4/packages/api-derive/src/accounts/indexes.ts#L75)*
