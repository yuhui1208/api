...
*Defined in [packages/api-derive/src/accounts/indexes.ts:75](https://github.com/polkadot-js/api/blob/533abb76f/packages/api-derive/src/accounts/indexes.ts#L75)*
