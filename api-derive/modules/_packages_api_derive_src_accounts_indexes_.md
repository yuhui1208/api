...
*Defined in [packages/api-derive/src/accounts/indexes.ts:75](https://github.com/polkadot-js/api/blob/6df466d9e/packages/api-derive/src/accounts/indexes.ts#L75)*
