...
*Defined in [packages/api-derive/src/accounts/indexes.ts:75](https://github.com/polkadot-js/api/blob/6e6fa4a97c/packages/api-derive/src/accounts/indexes.ts#L75)*
