...
*Defined in [packages/api-derive/src/accounts/indexes.ts:75](https://github.com/polkadot-js/api/blob/c4323d5e94/packages/api-derive/src/accounts/indexes.ts#L75)*
