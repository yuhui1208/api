...
*Defined in [packages/api-derive/src/staking/keys.ts:26](https://github.com/polkadot-js/api/blob/45c2c40a3e/packages/api-derive/src/staking/keys.ts#L26)*
...
*Defined in [packages/api-derive/src/staking/keys.ts:34](https://github.com/polkadot-js/api/blob/45c2c40a3e/packages/api-derive/src/staking/keys.ts#L34)*
