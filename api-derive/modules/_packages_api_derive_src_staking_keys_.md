...
*Defined in [packages/api-derive/src/staking/keys.ts:26](https://github.com/polkadot-js/api/blob/e7be062522/packages/api-derive/src/staking/keys.ts#L26)*
...
*Defined in [packages/api-derive/src/staking/keys.ts:34](https://github.com/polkadot-js/api/blob/e7be062522/packages/api-derive/src/staking/keys.ts#L34)*
