...
*Defined in [packages/api-derive/src/elections/info.ts:58](https://github.com/polkadot-js/api/blob/df229ffb8a/packages/api-derive/src/elections/info.ts#L58)*
