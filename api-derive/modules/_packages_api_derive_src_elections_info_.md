...
*Defined in [packages/api-derive/src/elections/info.ts:58](https://github.com/polkadot-js/api/blob/2f5e2537a3/packages/api-derive/src/elections/info.ts#L58)*
