...
*Defined in [packages/api-derive/src/elections/info.ts:58](https://github.com/polkadot-js/api/blob/637069d723/packages/api-derive/src/elections/info.ts#L58)*
