...
*Defined in [packages/api-derive/src/elections/info.ts:58](https://github.com/polkadot-js/api/blob/97527871d6/packages/api-derive/src/elections/info.ts#L58)*
