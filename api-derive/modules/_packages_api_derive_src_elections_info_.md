...
*Defined in [packages/api-derive/src/elections/info.ts:58](https://github.com/polkadot-js/api/blob/0e9a50e020/packages/api-derive/src/elections/info.ts#L58)*
