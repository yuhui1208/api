...
*Defined in [packages/api-derive/src/staking/query.ts:91](https://github.com/polkadot-js/api/blob/0a8d2e5ac1/packages/api-derive/src/staking/query.ts#L91)*
...
*Defined in [packages/api-derive/src/staking/query.ts:99](https://github.com/polkadot-js/api/blob/0a8d2e5ac1/packages/api-derive/src/staking/query.ts#L99)*
