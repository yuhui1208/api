...
*Defined in [packages/api-derive/src/staking/query.ts:91](https://github.com/polkadot-js/api/blob/c2705bdfda/packages/api-derive/src/staking/query.ts#L91)*
...
*Defined in [packages/api-derive/src/staking/query.ts:99](https://github.com/polkadot-js/api/blob/c2705bdfda/packages/api-derive/src/staking/query.ts#L99)*
