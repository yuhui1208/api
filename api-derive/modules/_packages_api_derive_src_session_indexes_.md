...
*Defined in [packages/api-derive/src/session/indexes.ts:79](https://github.com/polkadot-js/api/blob/f748fcd46d/packages/api-derive/src/session/indexes.ts#L79)*
