...
*Defined in [packages/api-derive/src/session/indexes.ts:79](https://github.com/polkadot-js/api/blob/658dda66a/packages/api-derive/src/session/indexes.ts#L79)*
