...
*Defined in [packages/api-derive/src/session/indexes.ts:79](https://github.com/polkadot-js/api/blob/0e9a50e020/packages/api-derive/src/session/indexes.ts#L79)*
