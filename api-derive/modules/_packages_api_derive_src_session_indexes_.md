...
*Defined in [packages/api-derive/src/session/indexes.ts:87](https://github.com/polkadot-js/api/blob/00bc441f0e/packages/api-derive/src/session/indexes.ts#L87)*
