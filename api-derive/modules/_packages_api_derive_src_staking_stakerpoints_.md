...
*Defined in [packages/api-derive/src/staking/stakerPoints.ts:14](https://github.com/polkadot-js/api/blob/1cf4d6b9b/packages/api-derive/src/staking/stakerPoints.ts#L14)*
...
*Defined in [packages/api-derive/src/staking/stakerPoints.ts:30](https://github.com/polkadot-js/api/blob/1cf4d6b9b/packages/api-derive/src/staking/stakerPoints.ts#L30)*
