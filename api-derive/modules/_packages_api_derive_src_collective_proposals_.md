...
*Defined in [packages/api-derive/src/collective/proposals.ts:32](https://github.com/polkadot-js/api/blob/658dda66a/packages/api-derive/src/collective/proposals.ts#L32)*
