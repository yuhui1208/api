...
*Defined in [packages/api-derive/src/collective/proposals.ts:32](https://github.com/polkadot-js/api/blob/54b4c2620/packages/api-derive/src/collective/proposals.ts#L32)*
