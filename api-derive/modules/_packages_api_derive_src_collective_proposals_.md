...
*Defined in [packages/api-derive/src/collective/proposals.ts:32](https://github.com/polkadot-js/api/blob/1cf4d6b9b/packages/api-derive/src/collective/proposals.ts#L32)*
