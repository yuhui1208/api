...
*Defined in [packages/api-derive/src/collective/proposals.ts:32](https://github.com/polkadot-js/api/blob/6df466d9e/packages/api-derive/src/collective/proposals.ts#L32)*
