...
*Defined in [packages/api-derive/src/collective/proposals.ts:32](https://github.com/polkadot-js/api/blob/01a36a994/packages/api-derive/src/collective/proposals.ts#L32)*
