...
*Defined in [packages/api-derive/src/collective/proposals.ts:32](https://github.com/polkadot-js/api/blob/00d3a1174/packages/api-derive/src/collective/proposals.ts#L32)*
