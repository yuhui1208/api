...
*Defined in [packages/api-derive/src/collective/proposals.ts:32](https://github.com/polkadot-js/api/blob/c7e6e4003/packages/api-derive/src/collective/proposals.ts#L32)*
