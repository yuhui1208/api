...
*Defined in [packages/api-derive/src/balances/account.ts:83](https://github.com/polkadot-js/api/blob/6f092a1818/packages/api-derive/src/balances/account.ts#L83)*
