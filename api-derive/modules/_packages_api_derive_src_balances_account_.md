...
*Defined in [packages/api-derive/src/balances/account.ts:83](https://github.com/polkadot-js/api/blob/01a36a994/packages/api-derive/src/balances/account.ts#L83)*
