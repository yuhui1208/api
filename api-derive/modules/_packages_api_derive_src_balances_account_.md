...
*Defined in [packages/api-derive/src/balances/account.ts:83](https://github.com/polkadot-js/api/blob/77c3a701d/packages/api-derive/src/balances/account.ts#L83)*
