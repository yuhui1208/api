...
*Defined in [packages/api-derive/src/balances/account.ts:83](https://github.com/polkadot-js/api/blob/658dda66a/packages/api-derive/src/balances/account.ts#L83)*
