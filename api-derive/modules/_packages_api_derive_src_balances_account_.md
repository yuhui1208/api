...
*Defined in [packages/api-derive/src/balances/account.ts:83](https://github.com/polkadot-js/api/blob/6e6fa4a97c/packages/api-derive/src/balances/account.ts#L83)*
