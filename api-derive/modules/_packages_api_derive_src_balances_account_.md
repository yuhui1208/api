...
*Defined in [packages/api-derive/src/balances/account.ts:83](https://github.com/polkadot-js/api/blob/00d3a1174/packages/api-derive/src/balances/account.ts#L83)*
