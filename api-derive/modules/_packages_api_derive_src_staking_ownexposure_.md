...
*Defined in [packages/api-derive/src/staking/ownExposure.ts:16](https://github.com/polkadot-js/api/blob/2f5e2537a3/packages/api-derive/src/staking/ownExposure.ts#L16)*
...
*Defined in [packages/api-derive/src/staking/ownExposure.ts:46](https://github.com/polkadot-js/api/blob/2f5e2537a3/packages/api-derive/src/staking/ownExposure.ts#L46)*
...
*Defined in [packages/api-derive/src/staking/ownExposure.ts:40](https://github.com/polkadot-js/api/blob/2f5e2537a3/packages/api-derive/src/staking/ownExposure.ts#L40)*
...
*Defined in [packages/api-derive/src/staking/ownExposure.ts:56](https://github.com/polkadot-js/api/blob/2f5e2537a3/packages/api-derive/src/staking/ownExposure.ts#L56)*
