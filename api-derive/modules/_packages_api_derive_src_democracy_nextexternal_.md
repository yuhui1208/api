...
*Defined in [packages/api-derive/src/democracy/nextExternal.ts:32](https://github.com/polkadot-js/api/blob/3c8cd499c/packages/api-derive/src/democracy/nextExternal.ts#L32)*
