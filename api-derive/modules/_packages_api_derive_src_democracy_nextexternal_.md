...
*Defined in [packages/api-derive/src/democracy/nextExternal.ts:32](https://github.com/polkadot-js/api/blob/6df466d9e/packages/api-derive/src/democracy/nextExternal.ts#L32)*
