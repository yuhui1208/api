...
*Defined in [packages/api-derive/src/democracy/nextExternal.ts:32](https://github.com/polkadot-js/api/blob/df229ffb8a/packages/api-derive/src/democracy/nextExternal.ts#L32)*
