...
*Defined in [packages/api-derive/src/accounts/accountId.ts:40](https://github.com/polkadot-js/api/blob/467ccc5681/packages/api-derive/src/accounts/accountId.ts#L40)*
