...
*Defined in [packages/api-derive/src/staking/electedInfo.ts:13](https://github.com/polkadot-js/api/blob/9f195e940/packages/api-derive/src/staking/electedInfo.ts#L13)*
