...
*Defined in [packages/api-derive/src/staking/electedInfo.ts:13](https://github.com/polkadot-js/api/blob/f43bc32573/packages/api-derive/src/staking/electedInfo.ts#L13)*
