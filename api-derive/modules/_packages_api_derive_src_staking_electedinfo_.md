...
*Defined in [packages/api-derive/src/staking/electedInfo.ts:13](https://github.com/polkadot-js/api/blob/a1df86468/packages/api-derive/src/staking/electedInfo.ts#L13)*
