...
*Defined in [packages/api-derive/src/staking/electedInfo.ts:13](https://github.com/polkadot-js/api/blob/2f5e2537a3/packages/api-derive/src/staking/electedInfo.ts#L13)*
