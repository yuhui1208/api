...
*Defined in [packages/api-derive/src/staking/electedInfo.ts:13](https://github.com/polkadot-js/api/blob/c2ff1b32a/packages/api-derive/src/staking/electedInfo.ts#L13)*
