...
*Defined in [packages/api-derive/src/staking/electedInfo.ts:13](https://github.com/polkadot-js/api/blob/519d9c8fa/packages/api-derive/src/staking/electedInfo.ts#L13)*
