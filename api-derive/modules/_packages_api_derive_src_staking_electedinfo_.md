...
*Defined in [packages/api-derive/src/staking/electedInfo.ts:13](https://github.com/polkadot-js/api/blob/1cf4d6b9b/packages/api-derive/src/staking/electedInfo.ts#L13)*
