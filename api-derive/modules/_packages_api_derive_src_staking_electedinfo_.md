...
*Defined in [packages/api-derive/src/staking/electedInfo.ts:13](https://github.com/polkadot-js/api/blob/df229ffb8a/packages/api-derive/src/staking/electedInfo.ts#L13)*
