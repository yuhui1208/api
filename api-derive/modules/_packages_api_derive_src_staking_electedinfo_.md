...
*Defined in [packages/api-derive/src/staking/electedInfo.ts:13](https://github.com/polkadot-js/api/blob/391c98c845/packages/api-derive/src/staking/electedInfo.ts#L13)*
