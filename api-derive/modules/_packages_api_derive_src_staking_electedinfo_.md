...
*Defined in [packages/api-derive/src/staking/electedInfo.ts:13](https://github.com/polkadot-js/api/blob/658dda66a/packages/api-derive/src/staking/electedInfo.ts#L13)*
