...
*Defined in [packages/api-derive/src/staking/electedInfo.ts:13](https://github.com/polkadot-js/api/blob/3c8cd499c/packages/api-derive/src/staking/electedInfo.ts#L13)*
