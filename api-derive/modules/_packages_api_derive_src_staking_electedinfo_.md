...
*Defined in [packages/api-derive/src/staking/electedInfo.ts:13](https://github.com/polkadot-js/api/blob/56e4cbdb2/packages/api-derive/src/staking/electedInfo.ts#L13)*
