...
*Defined in [packages/api-derive/src/staking/electedInfo.ts:13](https://github.com/polkadot-js/api/blob/ebe6d03762/packages/api-derive/src/staking/electedInfo.ts#L13)*
