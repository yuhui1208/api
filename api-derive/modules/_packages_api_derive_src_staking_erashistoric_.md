...
*Defined in [packages/api-derive/src/staking/erasHistoric.ts:15](https://github.com/polkadot-js/api/blob/97b5c699b/packages/api-derive/src/staking/erasHistoric.ts#L15)*
