...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/ce0523eb1/packages/api-derive/src/chain/getHeader.ts#L27)*
