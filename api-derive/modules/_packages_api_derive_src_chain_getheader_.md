...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/59bb5f864/packages/api-derive/src/chain/getHeader.ts#L27)*
