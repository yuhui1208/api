...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/014f08c7c/packages/api-derive/src/chain/getHeader.ts#L27)*
