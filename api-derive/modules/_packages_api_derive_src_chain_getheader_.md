...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/391c98c845/packages/api-derive/src/chain/getHeader.ts#L27)*
