...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/6ca84425d/packages/api-derive/src/chain/getHeader.ts#L27)*
