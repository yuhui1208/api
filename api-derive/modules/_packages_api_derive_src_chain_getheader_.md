...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/54b4c2620/packages/api-derive/src/chain/getHeader.ts#L27)*
