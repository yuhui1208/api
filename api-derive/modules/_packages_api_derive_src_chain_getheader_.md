...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/45c2c40a3e/packages/api-derive/src/chain/getHeader.ts#L27)*
