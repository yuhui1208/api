...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/a8d1dd063/packages/api-derive/src/chain/getHeader.ts#L27)*
