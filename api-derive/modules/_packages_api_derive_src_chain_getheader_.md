...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/0a0aa742b/packages/api-derive/src/chain/getHeader.ts#L27)*
