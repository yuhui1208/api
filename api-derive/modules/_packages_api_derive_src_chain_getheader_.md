...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/0e9a50e020/packages/api-derive/src/chain/getHeader.ts#L27)*
