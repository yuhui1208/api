...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/9d1af1eae/packages/api-derive/src/chain/getHeader.ts#L27)*
