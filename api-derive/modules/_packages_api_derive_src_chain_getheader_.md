...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/e1cb62d2d/packages/api-derive/src/chain/getHeader.ts#L27)*
