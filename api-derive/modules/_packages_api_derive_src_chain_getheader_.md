...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/9f195e940/packages/api-derive/src/chain/getHeader.ts#L27)*
