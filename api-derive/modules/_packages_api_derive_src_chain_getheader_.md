...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/77c3a701d/packages/api-derive/src/chain/getHeader.ts#L27)*
