...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/28ef291c40/packages/api-derive/src/chain/getHeader.ts#L27)*
