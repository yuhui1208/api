...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/dac3261a16/packages/api-derive/src/chain/getHeader.ts#L27)*
