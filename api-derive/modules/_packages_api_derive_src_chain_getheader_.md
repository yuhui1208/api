...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/6f092a1818/packages/api-derive/src/chain/getHeader.ts#L27)*
