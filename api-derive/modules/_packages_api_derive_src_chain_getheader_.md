...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/e88ebf7b2e/packages/api-derive/src/chain/getHeader.ts#L27)*
