...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/609581430f/packages/api-derive/src/chain/getHeader.ts#L27)*
