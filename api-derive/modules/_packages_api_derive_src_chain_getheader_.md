...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/c2705bdfda/packages/api-derive/src/chain/getHeader.ts#L27)*
