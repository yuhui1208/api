...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/95dd13e218/packages/api-derive/src/chain/getHeader.ts#L27)*
