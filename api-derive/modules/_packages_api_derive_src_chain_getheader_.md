...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/1cf4d6b9b/packages/api-derive/src/chain/getHeader.ts#L27)*
