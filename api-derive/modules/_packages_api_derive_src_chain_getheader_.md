...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/2c3ef10513/packages/api-derive/src/chain/getHeader.ts#L27)*
