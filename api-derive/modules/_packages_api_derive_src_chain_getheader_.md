...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/5e8ae793c3/packages/api-derive/src/chain/getHeader.ts#L27)*
