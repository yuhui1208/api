...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/56e4cbdb2/packages/api-derive/src/chain/getHeader.ts#L27)*
