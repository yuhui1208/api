...
*Defined in [packages/api-derive/src/chain/getHeader.ts:27](https://github.com/polkadot-js/api/blob/eb6b3c5bd4/packages/api-derive/src/chain/getHeader.ts#L27)*
