...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:52](https://github.com/polkadot-js/api/blob/014f08c7c/packages/api-derive/src/accounts/indexToId.ts#L52)*
