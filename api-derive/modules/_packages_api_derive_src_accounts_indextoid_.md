...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:52](https://github.com/polkadot-js/api/blob/658dda66a/packages/api-derive/src/accounts/indexToId.ts#L52)*
