...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:52](https://github.com/polkadot-js/api/blob/0a0aa742b/packages/api-derive/src/accounts/indexToId.ts#L52)*
