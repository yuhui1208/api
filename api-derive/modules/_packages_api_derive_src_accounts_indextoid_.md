...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:52](https://github.com/polkadot-js/api/blob/c2ff1b32a/packages/api-derive/src/accounts/indexToId.ts#L52)*
