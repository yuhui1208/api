...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:52](https://github.com/polkadot-js/api/blob/97b5c699b/packages/api-derive/src/accounts/indexToId.ts#L52)*
