...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:52](https://github.com/polkadot-js/api/blob/519d9c8fa/packages/api-derive/src/accounts/indexToId.ts#L52)*
