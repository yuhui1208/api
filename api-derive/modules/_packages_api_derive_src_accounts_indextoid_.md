...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:52](https://github.com/polkadot-js/api/blob/2f78329738/packages/api-derive/src/accounts/indexToId.ts#L52)*
