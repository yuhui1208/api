...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:52](https://github.com/polkadot-js/api/blob/c7e6e4003/packages/api-derive/src/accounts/indexToId.ts#L52)*
