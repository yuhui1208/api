...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:52](https://github.com/polkadot-js/api/blob/6e6fa4a97c/packages/api-derive/src/accounts/indexToId.ts#L52)*
