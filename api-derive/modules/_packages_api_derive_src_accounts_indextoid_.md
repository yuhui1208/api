...
*Defined in [packages/api-derive/src/accounts/indexToId.ts:52](https://github.com/polkadot-js/api/blob/6df466d9e/packages/api-derive/src/accounts/indexToId.ts#L52)*
