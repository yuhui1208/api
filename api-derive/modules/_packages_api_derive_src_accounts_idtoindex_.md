...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/8f675053a4/packages/api-derive/src/accounts/idToIndex.ts#L28)*
