...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/3c8cd499c/packages/api-derive/src/accounts/idToIndex.ts#L28)*
