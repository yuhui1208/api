...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/c7e6e4003/packages/api-derive/src/accounts/idToIndex.ts#L28)*
