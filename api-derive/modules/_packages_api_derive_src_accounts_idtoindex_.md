...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/6e6fa4a97c/packages/api-derive/src/accounts/idToIndex.ts#L28)*
