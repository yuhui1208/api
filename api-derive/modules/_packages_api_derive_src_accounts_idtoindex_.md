...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/0a0aa742b/packages/api-derive/src/accounts/idToIndex.ts#L28)*
