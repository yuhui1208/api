...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/ebe6d03762/packages/api-derive/src/accounts/idToIndex.ts#L28)*
