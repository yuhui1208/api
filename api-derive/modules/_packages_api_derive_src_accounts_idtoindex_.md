...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/a1df86468/packages/api-derive/src/accounts/idToIndex.ts#L28)*
