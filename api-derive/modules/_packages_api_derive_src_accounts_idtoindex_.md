...
*Defined in [packages/api-derive/src/accounts/idToIndex.ts:28](https://github.com/polkadot-js/api/blob/2f5e2537a3/packages/api-derive/src/accounts/idToIndex.ts#L28)*
