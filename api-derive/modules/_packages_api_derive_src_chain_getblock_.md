...
*Defined in [packages/api-derive/src/chain/getBlock.ts:26](https://github.com/polkadot-js/api/blob/45c2c40a3e/packages/api-derive/src/chain/getBlock.ts#L26)*
