...
*Defined in [packages/api-derive/src/chain/getBlock.ts:26](https://github.com/polkadot-js/api/blob/24d8915005/packages/api-derive/src/chain/getBlock.ts#L26)*
