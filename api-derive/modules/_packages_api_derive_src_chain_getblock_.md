...
*Defined in [packages/api-derive/src/chain/getBlock.ts:26](https://github.com/polkadot-js/api/blob/f43bc32573/packages/api-derive/src/chain/getBlock.ts#L26)*
