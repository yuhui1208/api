...
*Defined in [packages/api-derive/src/chain/getBlock.ts:26](https://github.com/polkadot-js/api/blob/c2705bdfda/packages/api-derive/src/chain/getBlock.ts#L26)*
