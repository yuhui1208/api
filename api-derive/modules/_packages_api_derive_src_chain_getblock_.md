...
*Defined in [packages/api-derive/src/chain/getBlock.ts:26](https://github.com/polkadot-js/api/blob/df229ffb8a/packages/api-derive/src/chain/getBlock.ts#L26)*
