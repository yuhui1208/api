...
*Defined in [packages/api-derive/src/chain/getBlock.ts:26](https://github.com/polkadot-js/api/blob/609581430f/packages/api-derive/src/chain/getBlock.ts#L26)*
