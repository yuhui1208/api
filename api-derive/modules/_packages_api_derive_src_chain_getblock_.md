...
*Defined in [packages/api-derive/src/chain/getBlock.ts:26](https://github.com/polkadot-js/api/blob/065f39ba6d/packages/api-derive/src/chain/getBlock.ts#L26)*
