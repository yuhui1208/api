...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/70e0f19ad/packages/api-derive/src/session/eraLength.ts#L13)*
