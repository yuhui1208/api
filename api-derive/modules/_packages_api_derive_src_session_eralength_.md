...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/eb6b3c5bd4/packages/api-derive/src/session/eraLength.ts#L13)*
