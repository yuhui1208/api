...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/28ef291c40/packages/api-derive/src/session/eraLength.ts#L13)*
