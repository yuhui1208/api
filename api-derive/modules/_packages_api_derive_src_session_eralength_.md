...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/4ec42f1750/packages/api-derive/src/session/eraLength.ts#L13)*
