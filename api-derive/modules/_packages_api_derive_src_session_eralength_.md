...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/4b3b853c27/packages/api-derive/src/session/eraLength.ts#L13)*
