...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/45fb6d44ad/packages/api-derive/src/session/eraLength.ts#L13)*
