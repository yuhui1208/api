...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/9d1af1eae/packages/api-derive/src/session/eraLength.ts#L13)*
