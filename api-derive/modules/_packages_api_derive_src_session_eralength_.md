...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/f748fcd46d/packages/api-derive/src/session/eraLength.ts#L13)*
