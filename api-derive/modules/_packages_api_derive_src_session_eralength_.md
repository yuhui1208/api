...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/97b5c699b/packages/api-derive/src/session/eraLength.ts#L13)*
