...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/065f39ba6d/packages/api-derive/src/session/eraLength.ts#L13)*
