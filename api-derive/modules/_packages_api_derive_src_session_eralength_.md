...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/45c2c40a3e/packages/api-derive/src/session/eraLength.ts#L13)*
