...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/54b4c2620/packages/api-derive/src/session/eraLength.ts#L13)*
