...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/277ea92fd/packages/api-derive/src/session/eraLength.ts#L13)*
