...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/dac3261a16/packages/api-derive/src/session/eraLength.ts#L13)*
