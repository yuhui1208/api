...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/ce0523eb1/packages/api-derive/src/session/eraLength.ts#L13)*
