...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/b59b60ae1f/packages/api-derive/src/session/eraLength.ts#L13)*
