...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/5a90da5df8/packages/api-derive/src/session/eraLength.ts#L13)*
