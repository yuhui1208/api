...
*Defined in [packages/api-derive/src/session/eraLength.ts:13](https://github.com/polkadot-js/api/blob/82e71fd51/packages/api-derive/src/session/eraLength.ts#L13)*
