...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/6f092a1818/packages/api-derive/src/chain/bestNumber.ts#L25)*
