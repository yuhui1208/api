...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/0e9a50e020/packages/api-derive/src/chain/bestNumber.ts#L25)*
