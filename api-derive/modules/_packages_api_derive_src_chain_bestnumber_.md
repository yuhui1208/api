...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/533abb76f/packages/api-derive/src/chain/bestNumber.ts#L25)*
