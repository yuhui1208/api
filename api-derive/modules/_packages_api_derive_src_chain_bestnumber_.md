...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/2f5e2537a3/packages/api-derive/src/chain/bestNumber.ts#L25)*
