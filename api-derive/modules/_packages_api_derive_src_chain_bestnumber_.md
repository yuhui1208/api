...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/1beaf9f20/packages/api-derive/src/chain/bestNumber.ts#L25)*
