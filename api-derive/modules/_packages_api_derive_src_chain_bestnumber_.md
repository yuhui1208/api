...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/5e8ae793c3/packages/api-derive/src/chain/bestNumber.ts#L25)*
