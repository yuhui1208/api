...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/519d9c8fa/packages/api-derive/src/chain/bestNumber.ts#L25)*
