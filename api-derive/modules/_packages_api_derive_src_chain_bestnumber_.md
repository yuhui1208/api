...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/0a8d2e5ac1/packages/api-derive/src/chain/bestNumber.ts#L25)*
