...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/9f195e940/packages/api-derive/src/chain/bestNumber.ts#L25)*
