...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/45c2c40a3e/packages/api-derive/src/chain/bestNumber.ts#L25)*
