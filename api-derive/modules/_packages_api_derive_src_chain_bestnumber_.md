...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/2f78329738/packages/api-derive/src/chain/bestNumber.ts#L25)*
