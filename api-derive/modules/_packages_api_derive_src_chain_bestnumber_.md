...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/ebe6d03762/packages/api-derive/src/chain/bestNumber.ts#L25)*
