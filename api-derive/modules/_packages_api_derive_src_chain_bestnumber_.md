...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/54b4c2620/packages/api-derive/src/chain/bestNumber.ts#L25)*
