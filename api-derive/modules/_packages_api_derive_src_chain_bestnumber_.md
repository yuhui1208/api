...
*Defined in [packages/api-derive/src/chain/bestNumber.ts:25](https://github.com/polkadot-js/api/blob/77c3a701d/packages/api-derive/src/chain/bestNumber.ts#L25)*
