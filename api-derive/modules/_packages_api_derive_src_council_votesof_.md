...
*Defined in [packages/api-derive/src/council/votesOf.ts:13](https://github.com/polkadot-js/api/blob/01a36a994/packages/api-derive/src/council/votesOf.ts#L13)*
