...
*Defined in [packages/api-derive/src/council/votesOf.ts:13](https://github.com/polkadot-js/api/blob/8f675053a4/packages/api-derive/src/council/votesOf.ts#L13)*
