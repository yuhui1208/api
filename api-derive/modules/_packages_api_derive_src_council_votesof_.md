...
*Defined in [packages/api-derive/src/council/votesOf.ts:13](https://github.com/polkadot-js/api/blob/014f08c7c/packages/api-derive/src/council/votesOf.ts#L13)*
