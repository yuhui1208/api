...
*Defined in [packages/api-derive/src/council/votesOf.ts:13](https://github.com/polkadot-js/api/blob/3c8cd499c/packages/api-derive/src/council/votesOf.ts#L13)*
