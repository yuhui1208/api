...
*Defined in [packages/api-derive/src/council/votesOf.ts:13](https://github.com/polkadot-js/api/blob/77c3a701d/packages/api-derive/src/council/votesOf.ts#L13)*
