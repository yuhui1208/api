...
*Defined in [packages/api-derive/src/council/votesOf.ts:13](https://github.com/polkadot-js/api/blob/6e6fa4a97c/packages/api-derive/src/council/votesOf.ts#L13)*
