...
*Defined in [packages/api-derive/src/council/votesOf.ts:13](https://github.com/polkadot-js/api/blob/519d9c8fa/packages/api-derive/src/council/votesOf.ts#L13)*
