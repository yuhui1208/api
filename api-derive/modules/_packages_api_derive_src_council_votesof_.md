...
*Defined in [packages/api-derive/src/council/votesOf.ts:13](https://github.com/polkadot-js/api/blob/2f5e2537a3/packages/api-derive/src/council/votesOf.ts#L13)*
