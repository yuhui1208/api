...
*Defined in [packages/api-derive/src/council/votesOf.ts:13](https://github.com/polkadot-js/api/blob/0e9a50e020/packages/api-derive/src/council/votesOf.ts#L13)*
