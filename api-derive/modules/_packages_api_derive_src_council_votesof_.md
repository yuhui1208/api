...
*Defined in [packages/api-derive/src/council/votesOf.ts:13](https://github.com/polkadot-js/api/blob/00d3a1174/packages/api-derive/src/council/votesOf.ts#L13)*
