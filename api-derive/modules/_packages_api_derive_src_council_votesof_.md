...
*Defined in [packages/api-derive/src/council/votesOf.ts:13](https://github.com/polkadot-js/api/blob/df229ffb8a/packages/api-derive/src/council/votesOf.ts#L13)*
