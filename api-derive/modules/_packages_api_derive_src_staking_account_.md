...
*Defined in [packages/api-derive/src/staking/account.ts:93](https://github.com/polkadot-js/api/blob/77c3a701d/packages/api-derive/src/staking/account.ts#L93)*
...
*Defined in [packages/api-derive/src/staking/account.ts:78](https://github.com/polkadot-js/api/blob/77c3a701d/packages/api-derive/src/staking/account.ts#L78)*
