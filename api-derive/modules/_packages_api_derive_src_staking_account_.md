...
*Defined in [packages/api-derive/src/staking/account.ts:93](https://github.com/polkadot-js/api/blob/00d3a1174/packages/api-derive/src/staking/account.ts#L93)*
...
*Defined in [packages/api-derive/src/staking/account.ts:78](https://github.com/polkadot-js/api/blob/00d3a1174/packages/api-derive/src/staking/account.ts#L78)*
