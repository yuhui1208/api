...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/014f08c7c/packages/api-derive/src/staking/overview.ts#L16)*
