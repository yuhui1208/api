...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/2c3ef10513/packages/api-derive/src/staking/overview.ts#L16)*
