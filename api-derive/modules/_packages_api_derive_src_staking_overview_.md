...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/df229ffb8a/packages/api-derive/src/staking/overview.ts#L16)*
