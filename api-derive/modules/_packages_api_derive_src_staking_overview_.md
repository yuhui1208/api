...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/c4323d5e94/packages/api-derive/src/staking/overview.ts#L16)*
