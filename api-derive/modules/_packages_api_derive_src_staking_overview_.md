...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/6e6fa4a97c/packages/api-derive/src/staking/overview.ts#L16)*
