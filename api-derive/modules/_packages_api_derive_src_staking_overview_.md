...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/ebe6d03762/packages/api-derive/src/staking/overview.ts#L16)*
