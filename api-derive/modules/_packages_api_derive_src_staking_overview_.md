...
*Defined in [packages/api-derive/src/staking/overview.ts:16](https://github.com/polkadot-js/api/blob/70e0f19ad/packages/api-derive/src/staking/overview.ts#L16)*
