...
*Defined in [packages/api-derive/src/contracts/fees.ts:48](https://github.com/polkadot-js/api/blob/2f78329738/packages/api-derive/src/contracts/fees.ts#L48)*
