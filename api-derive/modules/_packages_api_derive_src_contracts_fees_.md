...
*Defined in [packages/api-derive/src/contracts/fees.ts:48](https://github.com/polkadot-js/api/blob/97527871d6/packages/api-derive/src/contracts/fees.ts#L48)*
