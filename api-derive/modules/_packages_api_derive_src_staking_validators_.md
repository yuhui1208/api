...
*Defined in [packages/api-derive/src/staking/validators.ts:14](https://github.com/polkadot-js/api/blob/3c8cd499c/packages/api-derive/src/staking/validators.ts#L14)*
...
*Defined in [packages/api-derive/src/staking/validators.ts:30](https://github.com/polkadot-js/api/blob/3c8cd499c/packages/api-derive/src/staking/validators.ts#L30)*
