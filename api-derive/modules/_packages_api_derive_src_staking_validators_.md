...
*Defined in [packages/api-derive/src/staking/validators.ts:14](https://github.com/polkadot-js/api/blob/01a36a994/packages/api-derive/src/staking/validators.ts#L14)*
...
*Defined in [packages/api-derive/src/staking/validators.ts:30](https://github.com/polkadot-js/api/blob/01a36a994/packages/api-derive/src/staking/validators.ts#L30)*
