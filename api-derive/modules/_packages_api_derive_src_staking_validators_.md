...
*Defined in [packages/api-derive/src/staking/validators.ts:14](https://github.com/polkadot-js/api/blob/0a8d2e5ac1/packages/api-derive/src/staking/validators.ts#L14)*
...
*Defined in [packages/api-derive/src/staking/validators.ts:30](https://github.com/polkadot-js/api/blob/0a8d2e5ac1/packages/api-derive/src/staking/validators.ts#L30)*
