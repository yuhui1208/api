...
*Defined in [packages/api/src/types/base.ts:52](https://github.com/polkadot-js/api/blob/0a8d2e5ac1/packages/api/src/types/base.ts#L52)*
...
*Defined in [packages/api/src/types/base.ts:53](https://github.com/polkadot-js/api/blob/0a8d2e5ac1/packages/api/src/types/base.ts#L53)*
...
*Defined in [packages/api/src/types/rpc.ts:14](https://github.com/polkadot-js/api/blob/0a8d2e5ac1/packages/api/src/types/rpc.ts#L14)*
