...
*Defined in [packages/api/src/types/base.ts:50](https://github.com/polkadot-js/api/blob/6bd10daf43/packages/api/src/types/base.ts#L50)*
...
*Defined in [packages/api/src/types/base.ts:51](https://github.com/polkadot-js/api/blob/6bd10daf43/packages/api/src/types/base.ts#L51)*
...
*Defined in [packages/api/src/types/rpc.ts:12](https://github.com/polkadot-js/api/blob/6bd10daf43/packages/api/src/types/rpc.ts#L12)*
