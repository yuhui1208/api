...
*Defined in [packages/api/src/types/storage.ts:67](https://github.com/polkadot-js/api/blob/c2705bdfda/packages/api/src/types/storage.ts#L67)*
...
*Defined in [packages/api/src/types/storage.ts:68](https://github.com/polkadot-js/api/blob/c2705bdfda/packages/api/src/types/storage.ts#L68)*
