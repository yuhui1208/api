...
*Defined in [packages/api/src/types/storage.ts:67](https://github.com/polkadot-js/api/blob/e7be062522/packages/api/src/types/storage.ts#L67)*
...
*Defined in [packages/api/src/types/storage.ts:68](https://github.com/polkadot-js/api/blob/e7be062522/packages/api/src/types/storage.ts#L68)*
