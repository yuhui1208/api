...
*Defined in [packages/api/src/types/storage.ts:76](https://github.com/polkadot-js/api/blob/54b4c2620/packages/api/src/types/storage.ts#L76)*
...
*Defined in [packages/api/src/types/storage.ts:77](https://github.com/polkadot-js/api/blob/54b4c2620/packages/api/src/types/storage.ts#L77)*
