...
*Defined in [packages/api/src/types/storage.ts:67](https://github.com/polkadot-js/api/blob/395dc79ef7/packages/api/src/types/storage.ts#L67)*
...
*Defined in [packages/api/src/types/storage.ts:68](https://github.com/polkadot-js/api/blob/395dc79ef7/packages/api/src/types/storage.ts#L68)*
