...
*Defined in [packages/api/src/types/storage.ts:22](https://github.com/polkadot-js/api/blob/609581430f/packages/api/src/types/storage.ts#L22)*
...
*Defined in [packages/api/src/types/storage.ts:23](https://github.com/polkadot-js/api/blob/609581430f/packages/api/src/types/storage.ts#L23)*
...
*Defined in [packages/api/src/types/storage.ts:24](https://github.com/polkadot-js/api/blob/609581430f/packages/api/src/types/storage.ts#L24)*
...
*Defined in [packages/api/src/types/storage.ts:25](https://github.com/polkadot-js/api/blob/609581430f/packages/api/src/types/storage.ts#L25)*
...
*Defined in [packages/api/src/types/storage.ts:26](https://github.com/polkadot-js/api/blob/609581430f/packages/api/src/types/storage.ts#L26)*
