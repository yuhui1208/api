...
*Defined in [packages/api/src/types/storage.ts:56](https://github.com/polkadot-js/api/blob/956e17332/packages/api/src/types/storage.ts#L56)*
...
*Defined in [packages/api/src/types/storage.ts:57](https://github.com/polkadot-js/api/blob/956e17332/packages/api/src/types/storage.ts#L57)*
...
*Defined in [packages/api/src/types/storage.ts:58](https://github.com/polkadot-js/api/blob/956e17332/packages/api/src/types/storage.ts#L58)*
...
*Defined in [packages/api/src/types/storage.ts:59](https://github.com/polkadot-js/api/blob/956e17332/packages/api/src/types/storage.ts#L59)*
...
*Defined in [packages/api/src/types/storage.ts:60](https://github.com/polkadot-js/api/blob/956e17332/packages/api/src/types/storage.ts#L60)*
