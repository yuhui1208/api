...
*Defined in [packages/api/src/types/storage.ts:84](https://github.com/polkadot-js/api/blob/609581430f/packages/api/src/types/storage.ts#L84)*
...
*Defined in [packages/api/src/types/storage.ts:86](https://github.com/polkadot-js/api/blob/609581430f/packages/api/src/types/storage.ts#L86)*
...
*Defined in [packages/api/src/types/storage.ts:33](https://github.com/polkadot-js/api/blob/609581430f/packages/api/src/types/storage.ts#L33)*
...
*Defined in [packages/api/src/types/storage.ts:72](https://github.com/polkadot-js/api/blob/609581430f/packages/api/src/types/storage.ts#L72)*
...
*Defined in [packages/api/src/types/storage.ts:59](https://github.com/polkadot-js/api/blob/609581430f/packages/api/src/types/storage.ts#L59)*
