...
*Defined in [packages/api/src/types/storage.ts:16](https://github.com/polkadot-js/api/blob/6e6fa4a97c/packages/api/src/types/storage.ts#L16)*
...
*Defined in [packages/api/src/types/storage.ts:18](https://github.com/polkadot-js/api/blob/6e6fa4a97c/packages/api/src/types/storage.ts#L18)*
...
*Defined in [packages/api/src/types/storage.ts:23](https://github.com/polkadot-js/api/blob/6e6fa4a97c/packages/api/src/types/storage.ts#L23)*
...
*Defined in [packages/api/src/types/storage.ts:81](https://github.com/polkadot-js/api/blob/6e6fa4a97c/packages/api/src/types/storage.ts#L81)*
...
*Defined in [packages/api/src/types/storage.ts:68](https://github.com/polkadot-js/api/blob/6e6fa4a97c/packages/api/src/types/storage.ts#L68)*
