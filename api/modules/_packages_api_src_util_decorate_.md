...
*Defined in [packages/api/src/util/decorate.ts:13](https://github.com/polkadot-js/api/blob/77c3a701d/packages/api/src/util/decorate.ts#L13)*
...
*Defined in [packages/api/src/util/decorate.ts:44](https://github.com/polkadot-js/api/blob/77c3a701d/packages/api/src/util/decorate.ts#L44)*
