...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/95dd13e218/packages/api/src/submittable/createClass.ts#L26)*
