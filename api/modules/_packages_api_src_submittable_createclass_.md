...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/2f78329738/packages/api/src/submittable/createClass.ts#L26)*
