...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/97527871d6/packages/api/src/submittable/createClass.ts#L26)*
