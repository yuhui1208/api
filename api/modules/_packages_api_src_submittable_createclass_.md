...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/c2705bdfda/packages/api/src/submittable/createClass.ts#L26)*
