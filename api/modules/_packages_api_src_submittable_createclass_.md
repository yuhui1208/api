...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/533f9ce249/packages/api/src/submittable/createClass.ts#L26)*
