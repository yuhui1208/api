...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/4ec42f1750/packages/api/src/submittable/createClass.ts#L26)*
