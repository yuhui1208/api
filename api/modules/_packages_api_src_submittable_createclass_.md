...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/fcfcbb2d9/packages/api/src/submittable/createClass.ts#L26)*
