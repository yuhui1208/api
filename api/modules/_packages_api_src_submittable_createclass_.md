...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/ce0523eb1/packages/api/src/submittable/createClass.ts#L26)*
