...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/45c2c40a3e/packages/api/src/submittable/createClass.ts#L26)*
