...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/b579b18fad/packages/api/src/submittable/createClass.ts#L26)*
