...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/d099cceda/packages/api/src/submittable/createClass.ts#L26)*
