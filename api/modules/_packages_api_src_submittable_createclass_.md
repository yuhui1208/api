...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/3d67b75059/packages/api/src/submittable/createClass.ts#L26)*
