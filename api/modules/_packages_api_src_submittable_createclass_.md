...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/a8d1dd063/packages/api/src/submittable/createClass.ts#L26)*
