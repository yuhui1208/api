...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/53655019b/packages/api/src/submittable/createClass.ts#L26)*
