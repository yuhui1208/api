...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/00d3a1174/packages/api/src/submittable/createClass.ts#L26)*
