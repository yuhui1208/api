...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/28ef291c40/packages/api/src/submittable/createClass.ts#L26)*
