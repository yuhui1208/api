...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/ebe6d03762/packages/api/src/submittable/createClass.ts#L26)*
