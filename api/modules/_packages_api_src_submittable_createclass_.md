...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/5e8ae793c3/packages/api/src/submittable/createClass.ts#L26)*
