...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/b59b60ae1f/packages/api/src/submittable/createClass.ts#L26)*
