...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/35c37aa66/packages/api/src/submittable/createClass.ts#L26)*
