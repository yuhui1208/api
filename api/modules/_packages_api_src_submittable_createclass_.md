...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/7a1089df79/packages/api/src/submittable/createClass.ts#L26)*
