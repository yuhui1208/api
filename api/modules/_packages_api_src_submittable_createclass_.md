...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/519d9c8fa/packages/api/src/submittable/createClass.ts#L26)*
