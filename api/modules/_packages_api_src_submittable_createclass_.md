...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/0075dce720/packages/api/src/submittable/createClass.ts#L26)*
