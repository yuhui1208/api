...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/9d1af1eae/packages/api/src/submittable/createClass.ts#L26)*
