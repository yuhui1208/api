...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/6239818c2/packages/api/src/submittable/createClass.ts#L26)*
