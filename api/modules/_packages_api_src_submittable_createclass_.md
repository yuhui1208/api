...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/56e4cbdb2/packages/api/src/submittable/createClass.ts#L26)*
