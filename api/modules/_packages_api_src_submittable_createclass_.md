...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/0e9a50e020/packages/api/src/submittable/createClass.ts#L26)*
