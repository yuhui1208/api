...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/fe951c264/packages/api/src/submittable/createClass.ts#L26)*
