...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/eee36537d/packages/api/src/submittable/createClass.ts#L26)*
