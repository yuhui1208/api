...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/68856e969/packages/api/src/submittable/createClass.ts#L26)*
