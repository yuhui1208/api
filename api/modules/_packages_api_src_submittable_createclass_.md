...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/ad8ad42344/packages/api/src/submittable/createClass.ts#L26)*
