...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/5eb491dc6/packages/api/src/submittable/createClass.ts#L26)*
