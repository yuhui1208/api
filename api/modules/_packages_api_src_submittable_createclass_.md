...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/dac3261a16/packages/api/src/submittable/createClass.ts#L26)*
