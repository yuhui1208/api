...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/658dda66a/packages/api/src/submittable/createClass.ts#L26)*
