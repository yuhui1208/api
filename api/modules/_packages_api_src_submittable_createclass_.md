...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/0a8d2e5ac1/packages/api/src/submittable/createClass.ts#L26)*
