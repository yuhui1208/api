...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/6e6fa4a97c/packages/api/src/submittable/createClass.ts#L26)*
