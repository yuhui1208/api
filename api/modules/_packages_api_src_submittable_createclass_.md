...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/80c578fe7/packages/api/src/submittable/createClass.ts#L26)*
