...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/eb6b3c5bd4/packages/api/src/submittable/createClass.ts#L26)*
