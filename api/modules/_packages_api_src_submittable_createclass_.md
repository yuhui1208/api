...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/1beaf9f20/packages/api/src/submittable/createClass.ts#L26)*
