...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/6bd10daf43/packages/api/src/submittable/createClass.ts#L26)*
