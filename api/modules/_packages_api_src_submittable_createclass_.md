...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/533abb76f/packages/api/src/submittable/createClass.ts#L26)*
