...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/3cf67c975/packages/api/src/submittable/createClass.ts#L26)*
