...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/277ea92fd/packages/api/src/submittable/createClass.ts#L26)*
