...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/00bc441f0e/packages/api/src/submittable/createClass.ts#L26)*
