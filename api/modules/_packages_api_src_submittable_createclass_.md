...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/5af98cc89e/packages/api/src/submittable/createClass.ts#L26)*
