...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/430beb9f25/packages/api/src/submittable/createClass.ts#L26)*
