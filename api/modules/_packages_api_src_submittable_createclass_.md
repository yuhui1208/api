...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/c4323d5e94/packages/api/src/submittable/createClass.ts#L26)*
