...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/59bb5f864/packages/api/src/submittable/createClass.ts#L26)*
