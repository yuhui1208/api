...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/6df466d9e/packages/api/src/submittable/createClass.ts#L26)*
