...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/8f675053a4/packages/api/src/submittable/createClass.ts#L26)*
