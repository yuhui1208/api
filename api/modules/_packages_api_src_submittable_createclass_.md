...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/2c3ef10513/packages/api/src/submittable/createClass.ts#L26)*
