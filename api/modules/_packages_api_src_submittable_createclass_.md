...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/f43bc32573/packages/api/src/submittable/createClass.ts#L26)*
