...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/2f5e2537a3/packages/api/src/submittable/createClass.ts#L26)*
