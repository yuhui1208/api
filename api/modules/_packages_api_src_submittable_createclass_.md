...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/e425a38a7c/packages/api/src/submittable/createClass.ts#L26)*
