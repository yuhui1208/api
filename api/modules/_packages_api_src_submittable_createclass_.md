...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/df229ffb8a/packages/api/src/submittable/createClass.ts#L26)*
