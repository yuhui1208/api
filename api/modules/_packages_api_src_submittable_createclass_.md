...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/77c3a701d/packages/api/src/submittable/createClass.ts#L26)*
