...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/5a90da5df8/packages/api/src/submittable/createClass.ts#L26)*
