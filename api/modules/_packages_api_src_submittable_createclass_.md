...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/45fb6d44ad/packages/api/src/submittable/createClass.ts#L26)*
