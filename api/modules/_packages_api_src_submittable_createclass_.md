...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/94e9fd2b17/packages/api/src/submittable/createClass.ts#L26)*
