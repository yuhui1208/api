...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/70e0f19ad/packages/api/src/submittable/createClass.ts#L26)*
