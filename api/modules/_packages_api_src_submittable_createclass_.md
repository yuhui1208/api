...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/0a0aa742b/packages/api/src/submittable/createClass.ts#L26)*
