...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/1cf4d6b9b/packages/api/src/submittable/createClass.ts#L26)*
