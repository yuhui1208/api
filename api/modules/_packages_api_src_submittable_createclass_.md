...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/5856ce24c/packages/api/src/submittable/createClass.ts#L26)*
