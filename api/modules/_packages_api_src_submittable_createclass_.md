...
*Defined in [packages/api/src/submittable/createClass.ts:26](https://github.com/polkadot-js/api/blob/82e71fd51/packages/api/src/submittable/createClass.ts#L26)*
