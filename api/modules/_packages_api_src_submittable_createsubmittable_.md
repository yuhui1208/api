...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/54b4c2620/packages/api/src/submittable/createSubmittable.ts#L17)*
