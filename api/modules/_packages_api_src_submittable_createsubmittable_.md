...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/5adc846e4/packages/api/src/submittable/createSubmittable.ts#L17)*
