...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/6239818c2/packages/api/src/submittable/createSubmittable.ts#L17)*
