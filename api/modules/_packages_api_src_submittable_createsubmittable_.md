...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/df229ffb8a/packages/api/src/submittable/createSubmittable.ts#L17)*
