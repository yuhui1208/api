...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/a8d1dd063/packages/api/src/submittable/createSubmittable.ts#L17)*
