...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/9d1af1eae/packages/api/src/submittable/createSubmittable.ts#L17)*
