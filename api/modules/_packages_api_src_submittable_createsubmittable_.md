...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/f7c1b6e81/packages/api/src/submittable/createSubmittable.ts#L17)*
