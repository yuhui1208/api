...
*Defined in [packages/api/src/submittable/createSubmittable.ts:14](https://github.com/polkadot-js/api/blob/065f39ba6d/packages/api/src/submittable/createSubmittable.ts#L14)*
