...
*Defined in [packages/api/src/submittable/createSubmittable.ts:14](https://github.com/polkadot-js/api/blob/45c2c40a3e/packages/api/src/submittable/createSubmittable.ts#L14)*
