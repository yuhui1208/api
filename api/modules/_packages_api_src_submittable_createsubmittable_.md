...
*Defined in [packages/api/src/submittable/createSubmittable.ts:14](https://github.com/polkadot-js/api/blob/918bb73547/packages/api/src/submittable/createSubmittable.ts#L14)*
