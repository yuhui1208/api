...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/277ea92fd/packages/api/src/submittable/createSubmittable.ts#L17)*
