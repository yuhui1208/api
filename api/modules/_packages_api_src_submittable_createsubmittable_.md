...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/3d67b75059/packages/api/src/submittable/createSubmittable.ts#L17)*
