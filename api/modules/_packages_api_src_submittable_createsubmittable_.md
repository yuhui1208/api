...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/f748fcd46d/packages/api/src/submittable/createSubmittable.ts#L17)*
