...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/3cf67c975/packages/api/src/submittable/createSubmittable.ts#L17)*
