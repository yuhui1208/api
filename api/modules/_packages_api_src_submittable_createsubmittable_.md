...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/eee36537d/packages/api/src/submittable/createSubmittable.ts#L17)*
