...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/97b5c699b/packages/api/src/submittable/createSubmittable.ts#L17)*
