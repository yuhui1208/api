...
*Defined in [packages/api/src/submittable/createSubmittable.ts:14](https://github.com/polkadot-js/api/blob/2c3ef10513/packages/api/src/submittable/createSubmittable.ts#L14)*
