...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/6e6fa4a97c/packages/api/src/submittable/createSubmittable.ts#L17)*
