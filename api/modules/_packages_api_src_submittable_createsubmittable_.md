...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/7a1089df79/packages/api/src/submittable/createSubmittable.ts#L17)*
