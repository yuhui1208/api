...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/658dda66a/packages/api/src/submittable/createSubmittable.ts#L17)*
