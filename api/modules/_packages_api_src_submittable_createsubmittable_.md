...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/01a36a994/packages/api/src/submittable/createSubmittable.ts#L17)*
