...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/3c8cd499c/packages/api/src/submittable/createSubmittable.ts#L17)*
