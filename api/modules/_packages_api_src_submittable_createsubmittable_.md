...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/9f195e940/packages/api/src/submittable/createSubmittable.ts#L17)*
