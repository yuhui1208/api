...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/59bb5f864/packages/api/src/submittable/createSubmittable.ts#L17)*
