...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/fcfcbb2d9/packages/api/src/submittable/createSubmittable.ts#L17)*
