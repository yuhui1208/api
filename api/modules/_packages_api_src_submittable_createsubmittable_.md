...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/ce0523eb1/packages/api/src/submittable/createSubmittable.ts#L17)*
