...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/45fb6d44ad/packages/api/src/submittable/createSubmittable.ts#L17)*
