...
*Defined in [packages/api/src/submittable/createSubmittable.ts:14](https://github.com/polkadot-js/api/blob/95dd13e218/packages/api/src/submittable/createSubmittable.ts#L14)*
