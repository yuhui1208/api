...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/70e0f19ad/packages/api/src/submittable/createSubmittable.ts#L17)*
