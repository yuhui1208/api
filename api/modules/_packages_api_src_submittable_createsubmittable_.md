...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/c2ff1b32a/packages/api/src/submittable/createSubmittable.ts#L17)*
