...
*Defined in [packages/api/src/submittable/createSubmittable.ts:14](https://github.com/polkadot-js/api/blob/e425a38a7c/packages/api/src/submittable/createSubmittable.ts#L14)*
