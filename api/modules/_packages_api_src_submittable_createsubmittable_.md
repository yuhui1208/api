...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/97527871d6/packages/api/src/submittable/createSubmittable.ts#L17)*
