...
*Defined in [packages/api/src/submittable/createSubmittable.ts:14](https://github.com/polkadot-js/api/blob/00bc441f0e/packages/api/src/submittable/createSubmittable.ts#L14)*
