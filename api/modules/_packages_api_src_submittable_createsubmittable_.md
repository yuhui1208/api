...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/35c37aa66/packages/api/src/submittable/createSubmittable.ts#L17)*
