...
*Defined in [packages/api/src/submittable/createSubmittable.ts:14](https://github.com/polkadot-js/api/blob/dac3261a16/packages/api/src/submittable/createSubmittable.ts#L14)*
