...
*Defined in [packages/api/src/submittable/createSubmittable.ts:14](https://github.com/polkadot-js/api/blob/ad8ad42344/packages/api/src/submittable/createSubmittable.ts#L14)*
