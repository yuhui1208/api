...
*Defined in [packages/api/src/submittable/createSubmittable.ts:14](https://github.com/polkadot-js/api/blob/b59b60ae1f/packages/api/src/submittable/createSubmittable.ts#L14)*
