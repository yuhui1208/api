...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/f43bc32573/packages/api/src/submittable/createSubmittable.ts#L17)*
