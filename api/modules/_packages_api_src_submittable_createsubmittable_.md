...
*Defined in [packages/api/src/submittable/createSubmittable.ts:14](https://github.com/polkadot-js/api/blob/825365bb13/packages/api/src/submittable/createSubmittable.ts#L14)*
