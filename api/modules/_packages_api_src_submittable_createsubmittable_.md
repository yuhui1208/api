...
*Defined in [packages/api/src/submittable/createSubmittable.ts:14](https://github.com/polkadot-js/api/blob/b579b18fad/packages/api/src/submittable/createSubmittable.ts#L14)*
