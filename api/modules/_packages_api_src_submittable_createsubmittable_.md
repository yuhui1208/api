...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/014f08c7c/packages/api/src/submittable/createSubmittable.ts#L17)*
