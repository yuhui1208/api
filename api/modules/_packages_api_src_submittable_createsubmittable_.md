...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/fe951c264/packages/api/src/submittable/createSubmittable.ts#L17)*
