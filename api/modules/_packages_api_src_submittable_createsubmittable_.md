...
*Defined in [packages/api/src/submittable/createSubmittable.ts:14](https://github.com/polkadot-js/api/blob/c2705bdfda/packages/api/src/submittable/createSubmittable.ts#L14)*
