...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/0e9a50e020/packages/api/src/submittable/createSubmittable.ts#L17)*
