...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/1cf4d6b9b/packages/api/src/submittable/createSubmittable.ts#L17)*
