...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/391c98c845/packages/api/src/submittable/createSubmittable.ts#L17)*
