...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/eb6b3c5bd4/packages/api/src/submittable/createSubmittable.ts#L17)*
