...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/80c578fe7/packages/api/src/submittable/createSubmittable.ts#L17)*
