...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/e6806ed7f/packages/api/src/submittable/createSubmittable.ts#L17)*
