...
*Defined in [packages/api/src/submittable/createSubmittable.ts:17](https://github.com/polkadot-js/api/blob/d099cceda/packages/api/src/submittable/createSubmittable.ts#L17)*
