...
*Defined in [packages/api/src/promise/Combinator.ts:29](https://github.com/polkadot-js/api/blob/e6806ed7f/packages/api/src/promise/Combinator.ts#L29)*
...
*Defined in [packages/api/src/promise/Combinator.ts:79](https://github.com/polkadot-js/api/blob/e6806ed7f/packages/api/src/promise/Combinator.ts#L79)*
