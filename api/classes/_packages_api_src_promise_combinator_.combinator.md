...
*Defined in [packages/api/src/promise/Combinator.ts:29](https://github.com/polkadot-js/api/blob/cab338e26d/packages/api/src/promise/Combinator.ts#L29)*
...
*Defined in [packages/api/src/promise/Combinator.ts:79](https://github.com/polkadot-js/api/blob/cab338e26d/packages/api/src/promise/Combinator.ts#L79)*
