...
*Defined in [packages/api/src/base/Decorate.ts:107](https://github.com/polkadot-js/api/blob/6df466d9e/packages/api/src/base/Decorate.ts#L107)*
...
*Defined in [packages/api/src/base/Decorate.ts:162](https://github.com/polkadot-js/api/blob/6df466d9e/packages/api/src/base/Decorate.ts#L162)*
