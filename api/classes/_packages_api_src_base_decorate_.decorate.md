...
*Defined in [packages/api/src/base/Decorate.ts:107](https://github.com/polkadot-js/api/blob/1beaf9f20/packages/api/src/base/Decorate.ts#L107)*
...
*Defined in [packages/api/src/base/Decorate.ts:162](https://github.com/polkadot-js/api/blob/1beaf9f20/packages/api/src/base/Decorate.ts#L162)*
