...
*Defined in [packages/api/src/base/Decorate.ts:107](https://github.com/polkadot-js/api/blob/1cf4d6b9b/packages/api/src/base/Decorate.ts#L107)*
...
*Defined in [packages/api/src/base/Decorate.ts:162](https://github.com/polkadot-js/api/blob/1cf4d6b9b/packages/api/src/base/Decorate.ts#L162)*
