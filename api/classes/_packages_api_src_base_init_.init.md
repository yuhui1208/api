...
*Defined in [packages/api/src/base/Init.ts:37](https://github.com/polkadot-js/api/blob/97527871d6/packages/api/src/base/Init.ts#L37)*
...
*Defined in [packages/api/src/base/Decorate.ts:169](https://github.com/polkadot-js/api/blob/97527871d6/packages/api/src/base/Decorate.ts#L169)*
