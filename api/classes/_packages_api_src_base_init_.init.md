...
*Defined in [packages/api/src/base/Init.ts:36](https://github.com/polkadot-js/api/blob/f748fcd46d/packages/api/src/base/Init.ts#L36)*
...
*Defined in [packages/api/src/base/Decorate.ts:169](https://github.com/polkadot-js/api/blob/f748fcd46d/packages/api/src/base/Decorate.ts#L169)*
