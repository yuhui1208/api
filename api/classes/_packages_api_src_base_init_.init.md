...
*Defined in [packages/api/src/base/Init.ts:30](https://github.com/polkadot-js/api/blob/e425a38a7c/packages/api/src/base/Init.ts#L30)*
...
*Defined in [packages/api/src/base/Decorate.ts:174](https://github.com/polkadot-js/api/blob/e425a38a7c/packages/api/src/base/Decorate.ts#L174)*
