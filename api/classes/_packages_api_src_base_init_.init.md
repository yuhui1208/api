...
*Defined in [packages/api/src/base/Init.ts:30](https://github.com/polkadot-js/api/blob/0a8d2e5ac1/packages/api/src/base/Init.ts#L30)*
...
*Defined in [packages/api/src/base/Decorate.ts:174](https://github.com/polkadot-js/api/blob/0a8d2e5ac1/packages/api/src/base/Decorate.ts#L174)*
