...
*Defined in [packages/api/src/base/Init.ts:35](https://github.com/polkadot-js/api/blob/45fb6d44ad/packages/api/src/base/Init.ts#L35)*
...
*Defined in [packages/api/src/base/Decorate.ts:169](https://github.com/polkadot-js/api/blob/45fb6d44ad/packages/api/src/base/Decorate.ts#L169)*
