...
*Defined in [packages/api/src/base/Init.ts:37](https://github.com/polkadot-js/api/blob/2f5e2537a3/packages/api/src/base/Init.ts#L37)*
...
*Defined in [packages/api/src/base/Decorate.ts:169](https://github.com/polkadot-js/api/blob/2f5e2537a3/packages/api/src/base/Decorate.ts#L169)*
